...
A nested collecton of undirected wiring diagrams.
"""
...
Factorize an undirected wiring diagram into a nested collected of undirected wiring
diagrams.
"""
function NestedUWD(
    diagram::UndirectedWiringDiagram,
...
Construct a directed wiring diagram that represents the nesting structure of a nested
collection of undirected wiring diagram.
"""
...
Evaluate a nested collection of undirected wiring diagrams given a set of generators for
the boxes. The optional first argument `f` should be callable with the signature
```
...
# For each node i, construct the undirected wiring diagram corresponding to i.
...
# Construct the undirected wiring diagram corresponding to node i.
